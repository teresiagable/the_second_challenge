...
public interface PlayerWalletService {
	...
	PlayerTransaction creditDebit(String externalId, PlayerAccount playerAccount, BigDecimal amount) throws SQLIntegrityConstraintViolationException, NotEnoughMoneyException;
